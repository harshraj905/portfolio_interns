                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-3 order-lg-1 order-md-2 order-sm-2">
                            <div class="card overflow-hidden">
                                <div class="card-body">
                                    <div class="pt-3">
                                        <h3 class="text-dark text-center font-24 fw-bold line-height-lg">Akriti
                                        <br>Multi Application</h3>
                                        <div class="text-center text-muted font-16 fw-bold pt-3 pb-1">I Design and Develop Clean and High Quality Web Applications</div>
                                    ...
                                    <div class="card overflow-hidden">
                                        <div class="card-body">
                                            <div class="row d-flex">
                                                <div class="col-3">
                                                    <i class='bx bx-group font-36 align-self-center text-dark' ></i>
                                                </div><!--end col-->
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card overflow-hidden">
                                        <div class="card-body">
                                            <div class="row d-flex">
                                                <div class="col-3">
                                                    <i class='bx bx-time font-36 align-self-center text-dark' ></i>
                                                </div><!--end col-->
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card overflow-hidden">
                                        <div class="card-body">
                                            <div class="row d-flex">
                                                <div class="col-3">
                                                    <i class='bx bx-stats font-36 align-self-center text-dark'></i>
                                                </div><!--end col-->
                                                <div class="col-12 ms-auto align-self-center">
                                                    <div id="dash_spark_3" class="mb-3"></div>
                                                </div><!--end col-->
                                                <div class="col-12 ms-auto align-self-center">
                                                    <h3 class="text-dark my-0 font-22 fw-bold"><span>&#8377;</span>1800</h3>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card overflow-hidden">
                                        <div class="card-body">
                                            <div class="row d-flex">
                                                <div class="col-3">
                                                    <i class='bx bx-party font-36 align-self-center text-dark'></i>
                                                </div><!--end col-->
                                                <div class="col-auto ms-auto align-self-center">
